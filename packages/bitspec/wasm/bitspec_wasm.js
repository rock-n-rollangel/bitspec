/* @ts-self-types="./bitspec_wasm.d.ts" */
...
export class WasmSchema {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        WasmSchemaFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_wasmschema_free(ptr, 0);
    }
    /**
    ...
    constructor(schema_json) {
        ...
        const ret = wasm.wasmschema_new(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        WasmSchemaFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
    ...
    parse(data) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmschema_parse(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
     ...
     */
    serialize(obj) {
        const ret = wasm.wasmschema_serialize(this.__wbg_ptr, obj);
        if (ret[3]) {
...
if (Symbol.dispose) WasmSchema.prototype[Symbol.dispose] = WasmSchema.prototype.free;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./bitspec_wasm_bg.js": import0,
    };
}

const WasmSchemaFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_wasmschema_free(ptr >>> 0, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('bitspec_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
